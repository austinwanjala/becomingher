...
class Store {
  ...
  public services: Service[] = [
    {
      ...
      features: [
        ...
        'Integrated 24/7 Digital Coaching Companion',
    ...
    },
    {
      ...
      short_description: 'A bespoke coaching experience curated uniquely around your individual life vision, challenges, and goals with personalized reflective guidance.',
      ...
      features: [
        ...
        'Personalized Reflection Companion Aligned to Your Profile',
        'Weekly Goal Reviews & Dynamic Action Prompts',
        'Unlimited Reflective Dialogue & Daily Accountability',
  ...
  public testimonials: Testimonial[] = [
    ...
    },
    {
      ...
      quote: 'The reflection companion is unlike anything I’ve used. It knows my goals, remembers my answers from Module 1, and pushes me with gentle, challenging inquiries.',
  ...
  public faqs: FAQItem[] = [
    {
      ...
      answer: 'Immediately after completing your payment via Selar, our system verifies your transaction and unlocks your active entitlement. You will be directed to your Customer Dashboard where all modules, exercises, and guided coaching become instantly available.',
    ...
    {
      id: 'faq-04',
      question: 'Is the Digital Coaching Companion a replacement for therapy or medical advice?',
      answer: 'No. The Digital Coaching Companion is strictly a personal development tool grounded in our approved Becoming Her frameworks. It does not provide medical, psychological, legal, or crisis treatment. If you are experiencing mental health emergencies, please contact licensed local medical professionals.',
  ...
  public cms: SiteCMSContent = {
    ...
    hero: {
      ...
      subheading: 'A curated sanctuary of structured digital programmes, intimate 1-on-1 coaching, and bespoke personal development tools designed to guide you into authentic sovereignty, confidence, and peace.',
  ...
  public whatsappConfig: WhatsAppConfig = {
    ...
    business_hours: 'Monday - Saturday: 8:00 AM - 8:00 PM (EAT). Digital Companion available 24/7.',
